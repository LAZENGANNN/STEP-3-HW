...
const age = Math.floor(Math.random() * 17);
console.log("2)", `
${age} лет
${age * 365} суток
${age * 365 * 5} BYN
...
const k1 = Math.floor(5 + Math.random() * (13 + 1 - 5));
const k2 = Math.floor(5 + Math.random() * (13 + 1 - 5));
const k3 = Math.floor(5 + Math.random() * (13 + 1 - 5));
...
const dollars = (age + 1) * 365 * 24 * 60 * 60 * 0.01;
...
console.log(`======f======`);
const size1 = Math.floor(5 + Math.random() * (17 + 1 - 5));
const size2 = Math.floor(5 + Math.random() * (17 + 1 - 5));
const arr1 = [];
const arr2 = [];
